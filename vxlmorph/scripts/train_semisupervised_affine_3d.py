"""
Script: train_semisupervised_affine_3d.py

Description:
This script trains a semi-supervised 3D image segmentation model using Voxelmorph and affine transformations.
...
Usage:
Run this script to train a semi-supervised 3D image segmentation model using affine transformations with specified
...
if __name__ == '__main__':
    ...
    training_params = config['Semi3DAffineTrainingParameters']
    ...
    train_gen = generators.semisupervised_affine(x_train, segmentations_train, labels=labels, batch_size=args.batch_size, volumetric=True)
    val_gen = generators.semisupervised_affine(x_val, segmentations_val, labels=labels,batch_size=args.batch_size, volumetric=True)
    test_gen = generators.semisupervised_affine(x_test, segmentations_test, labels=labels,batch_size=args.batch_size, volumetric=True)
