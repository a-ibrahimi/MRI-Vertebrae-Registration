...
def get_fnumber(path):
    """
    Returns file number given the file path convention used in this project
    
    Example:
        Input: '/local_ssd/practical_wise24/vertebra_labeling/data/spider_raw/sub-0083/T1w/sub-0083_T1w.nii.gz'
        Returns: '0083'
    """
